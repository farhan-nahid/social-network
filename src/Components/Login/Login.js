        ...
        <div className="form">
          ...
          {!newUser && <h5 className="mb-4">Log In</h5>}
            <form>
                ...
                {
                 newUser && <input type="submit" onClick={handleSignUp} className="form-control btn btn-primary"  value="Create New Account"/>
                 }

                 {
                 !newUser && <input type="submit" onClick={handleLogin} className="form-control btn btn-primary"  value="Log In"/>
                 }
